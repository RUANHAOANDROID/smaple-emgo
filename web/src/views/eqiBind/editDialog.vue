  ...
  <div :class="[collapse ? 'dialog-wrapper-collapse' : 'dialog-wrapper']">
    ...
    >
      ...
      >
        ...
        <!-- <div class="line"></div> -->
        <!-- <div class="title">单机提示设置</div> -->
        <!-- <el-form-item label="有效语音" prop="k" style="width: 208px">
            <el-input
              style="width: 208px"
              v-model="form.k"
              placeholder=""
          ...
          <el-form-item label="无效语音" prop="l">
            <el-input style="width: 208px" v-model="form.l"></el-input>
          </el-form-item>

          <el-form-item label="有效文字" prop="m">
            <el-input
              style="width: 208px"
              v-model="form.m"
              placeholder=""
          ...
          <el-form-item label="无效文字" prop="n" style="width: 208px">
            <el-input
              style="width: 208px"
              v-model="form.n"
              placeholder=""
...
export default {
  ...
  methods: {
    init() {
      ...
      this.form.deviceNo = this.editData.deviceNo;
      this.form.deviceIp = this.editData.deviceIp;
      this.form.deviceVersion = this.editData.deviceVersion;
      this.form.serialNumber = this.editData.serialNumber;
      // this.form.deviceStatus = this.editData.deviceStatus
    },
    cancel() {
      this.$emit("closeDialog2");
      this.$nextTick(() => {
    ...
    submit() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          fetchData(urls.updateDevice, bizModel, method.POST).then((res) => {
